...
from app.services.auto_ria.quota_limits import (
    AUTO_RIA_QUOTA_PACKAGES,
    DEFAULT_AUTO_RIA_QUOTA_PACKAGE,
    resolve_auto_ria_quota_limits,
)
...
class AutoRiaQuotaLimitsTests(unittest.TestCase):
    ...
    def test_default_package_when_empty(self):
        self.assertEqual(
            resolve_auto_ria_quota_limits("", 0, 0),
            (*AUTO_RIA_QUOTA_PACKAGES[DEFAULT_AUTO_RIA_QUOTA_PACKAGE], DEFAULT_AUTO_RIA_QUOTA_PACKAGE),
        )
