...
const sections = [
  {
    ...
    content: (
      <>
        ...
        <p>
          Актуальні тарифи також на сторінці <Link href="/pricing">Тарифи</Link>. Пробний
          період «Старт» (7 днів після реєстрації) не є платною послугою. Тариф «Безкоштовно»
          — безстроковий базовий доступ з 1 моніторингом.
        </p>
      </>
    ),
  },
