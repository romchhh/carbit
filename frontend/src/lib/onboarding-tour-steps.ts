...
export const ONBOARDING_TOUR_STEPS: OnboardingTourStep[] = [
  ...
  },
  {
    ...
    description:
      "Короткий список на головній. Повний — у вкладці «Мої моніторинги»; відкрийте запит, щоб побачити всі авто.",
    tips: [
      "Зелена крапка — моніторинг активний",
      "Бейдж із цифрою — скільки нових авто з’явилось",
      "Авто з першого пошуку теж зберігаються в моніторингу",
    ],
    placement: "top",
  },
  {
  ...
  },
  {
    ...
    section: "Акаунт",
    title: "Профіль і статистика",
    description:
      "Тут тариф, ліміт запитів, скільки авто сьогодні і що в обраному. Нижче — Telegram і налаштування.",
    tips: [
      "Статистика більше не окрема вкладка — усе в профілі",
      "«Підключити» Telegram → Start у боті",
    ],
    placement: "top",
  },
  {
    ...
    description: "Підключіть бота, щоб нові авто приходили прямо в месенджер.",
    tips: [
  ...
  },
  {
    ...
    tips: [
      ...
      "Ліміт запитів видно в профілі й у боковому меню",
    ],
    placement: "bottom",
  },
  {
