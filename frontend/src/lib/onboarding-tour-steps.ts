...
export const ONBOARDING_TOUR_STEPS: OnboardingTourStep[] = [
  ...
  },
  {
    ...
    description:
      "Зверху — коротке привітання. Нижче налаштовуєте фільтри й запускаєте моніторинг ринку.",
    tips: [
      "Моніторинги й ліміти тарифу видно в сайдбарі та в розділі «Підписка»",
      "Telegram підключається в Акаунті — тоді сповіщення приходять миттєво",
    ],
    placement: "bottom",
  },
  {
    ...
    tips: [
      ...
      "«Розширений пошук» — вік оголошення (свіжі / 15 / 30 днів), пробіг, КПП, тип кузова",
    ],
    placement: "bottom",
  },
  {
