    ...
    <div className={cn("space-y-4", className)}>
      <div className="flex flex-wrap items-center gap-2">
        ...
        {includePremiumFields ? (
          ...
          <Link href="/app/billing" className="text-[11px] font-semibold text-muted hover:text-emerald-dark">
...
export function CompareEmptyState() {
  return (
    <div className="rounded-2xl border border-dashed border-border bg-surface/40 px-6 py-12 text-center">
      ...
      <Link
        href="/app/dashboard"
        className="mt-5 inline-flex rounded-xl bg-emerald px-5 py-2.5 text-[13px] font-bold text-white hover:bg-emerald-dark"
      >
        Перейти до пошуку
      </Link>
    </div>
